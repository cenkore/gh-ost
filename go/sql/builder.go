...
func BuildRangeInsertQuery(databaseName, originalTableName, ghostTableName, whereStmt string, sharedColumns []string, mappedSharedColumns []string, uniqueKey string, uniqueKeyColumns *ColumnList, rangeStartValues, rangeEndValues []string, rangeStartArgs, rangeEndArgs []interface{}, includeRangeStartValues bool, transactionalTable bool, isAddUniqueKey bool) (result string, explodedArgs []interface{}, err error) {
    ...
    `, databaseName, originalTableName, databaseName, ghostTableName, mappedSharedColumnsListing,
			...
			rangeStartComparison, rangeEndComparison, whereStmt, transactionalClause)
	} else {
		var onJoins []string
		var nullStmt string
	...
	`,databaseName,originalTableName,databaseName,ghostTableName,mappedSharedColumnsListing,
			...
			strings.Join(onJoins," and "), rangeStartComparison, rangeEndComparison, whereStmt, nullStmt, transactionalClause)
	}
...
func BuildRangeInsertPreparedQuery(databaseName, originalTableName, ghostTableName, whereStmt string, sharedColumns []string, mappedSharedColumns []string, uniqueKey string, uniqueKeyColumns *ColumnList, rangeStartArgs, rangeEndArgs []interface{}, includeRangeStartValues bool, transactionalTable bool, isAddUniqueKey bool) (result string, explodedArgs []interface{}, err error) {
	...
	return BuildRangeInsertQuery(databaseName, originalTableName, ghostTableName, whereStmt, sharedColumns, mappedSharedColumns, uniqueKey, uniqueKeyColumns, rangeStartValues, rangeEndValues, rangeStartArgs, rangeEndArgs, includeRangeStartValues, transactionalTable, isAddUniqueKey)
}
